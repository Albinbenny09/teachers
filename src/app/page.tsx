...
const services = [
  { id: 1, title: "പ്രതിമാസ സമ്പാദ്യ പദ്ധതി", body: "We conduct about 30 monthly chits of worth Rs.55 lakhs", href: "/chit", img: "/image/chit.jpg" },
  { id: 2, title: "Loan", body: "Provide different types of loans against salary certificates & collateral", href: "/loan", img: "/image/loan.jpg" },
  { id: 3, title: "Deposits", body: "We accept deposits at attractive rates of interest", href: "/deposit", img: "/image/deposit.jpg" },
];
...
export default function Home() {
  ...
  return (
    <main className="font-sans">
      ...
      {/* Services */}
      <section id="services" className="py-16 md:py-24 lg:py-32 bg-gradient-to-b from-white to-slate-50/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight tracking-tight bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-6">Our Services</h2>
            ...
            <p className="text-lg md:text-xl leading-relaxed text-slate-600 max-w-3xl mx-auto">
              Comprehensive financial solutions designed specifically for educators, 
              providing security, growth, and peace of mind.
            </p>
          </div>
      ...
      {/* Mission & Vision */}
      <section id="mission" className="py-16 md:py-24 lg:py-32 bg-gradient-to-br from-slate-50 via-white to-blue-50/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight tracking-tight bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-6">Our Mission & Vision</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full mx-auto mb-8"></div>
            <p className="text-lg md:text-xl leading-relaxed text-slate-600 max-w-3xl mx-auto">
              Guided by our core values, we strive to create lasting impact in the education community.
            </p>
          </div>
            ...
            <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 overflow-hidden transition-all duration-700 hover:shadow-3xl hover:-translate-y-2 group">
              <div className="p-10 space-y-8">
                <div className="flex items-center gap-4">
                  ...
                  <h3 className="text-3xl md:text-4xl font-bold text-slate-900 m-0">Our Mission</h3>
                </div>
                <ul className="space-y-4">
                  <li className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-base md:text-lg leading-relaxed text-slate-600">Deliver reliable, teacher-first financial services</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-base md:text-lg leading-relaxed text-slate-600">Provide fair credit and transparent processes</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-base md:text-lg leading-relaxed text-slate-600">Strengthen community welfare and support</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 overflow-hidden transition-all duration-700 hover:shadow-3xl hover:-translate-y-2 group">
              <div className="p-10 space-y-8">
                <div className="flex items-center gap-4">
                  ...
                  <h3 className="text-3xl md:text-4xl font-bold text-slate-900 m-0">Our Vision</h3>
                </div>
                <ul className="space-y-4">
                  <li className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-base md:text-lg leading-relaxed text-slate-600">Be the most trusted co‑operative for teachers</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-base md:text-lg leading-relaxed text-slate-600">Lead with integrity, service quality, and innovation</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-base md:text-lg leading-relaxed text-slate-600">Make a measurable social impact in education</span>
                  </li>
                </ul>
              </div>
            </div>
      ...
      <section className="py-16 md:py-24 lg:py-32 bg-gradient-to-br from-slate-50 via-white to-blue-50/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              <div className="space-y-6">
                <h3 className="text-3xl md:text-4xl font-bold text-slate-900">Get Our Mobile App</h3>
                <p className="text-lg md:text-xl leading-relaxed text-slate-600">
                  Experience faster, more convenient access to all our services with our 
              ...
              <div className="space-y-6">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="flex items-center space-x-3 p-4 bg-white/50 rounded-xl backdrop-blur-sm">
                    ...
                    <span className="text-sm font-medium">Balance & Transactions</span>
                  </div>
                  <div className="flex items-center space-x-3 p-4 bg-white/50 rounded-xl backdrop-blur-sm">
                    <div className="w-8 h-8 bg-gradient-to-br from-blue-500 to-purple-500 rounded-lg flex items-center justify-center">
                      <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="flex items-center space-x-3 p-4 bg-white/50 rounded-xl backdrop-blur-sm">
                    ...
                    <span className="text-sm font-medium">Chit Auction Updates</span>
                  </div>
                  <div className="flex items-center space-x-3 p-4 bg-white/50 rounded-xl backdrop-blur-sm">
                    <div className="w-8 h-8 bg-gradient-to-br from-blue-500 to-purple-500 rounded-lg flex items-center justify-center">
                      <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="space-y-6">
              <h3 className="text-3xl md:text-4xl font-bold text-slate-900">Our Location</h3>
      ...
      {/* About */}
      <section id="about" className="py-16 md:py-24 lg:py-32 bg-gradient-to-b from-white to-slate-50/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight tracking-tight bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-6">About Us</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full mx-auto mb-8"></div>
            <p className="text-lg md:text-xl leading-relaxed text-slate-600 max-w-3xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 overflow-hidden transition-all duration-700 hover:shadow-3xl hover:-translate-y-2 group text-center">
                <div className="p-8 space-y-4">
                  ...
                  <h3 className="text-xl font-bold text-slate-900">Years of Service</h3>
                  <p className="text-sm font-medium text-slate-600">Serving the education community since 1981</p>
                </div>
              </div>
              ...
              <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 overflow-hidden transition-all duration-700 hover:shadow-3xl hover:-translate-y-2 group text-center">
                <div className="p-8 space-y-4">
                  ...
                  <h3 className="text-xl font-bold text-slate-900">Audit Grade</h3>
                  <p className="text-sm font-medium text-slate-600">Class I Special Grade Co-operative Society</p>
                </div>
              </div>
              ...
              <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 overflow-hidden transition-all duration-700 hover:shadow-3xl hover:-translate-y-2 group text-center">
                <div className="p-8 space-y-4">
                  ...
                  <h3 className="text-xl font-bold text-slate-900">Monthly Chits</h3>
                  <p className="text-sm font-medium text-slate-600">Conducting 30 monthly chits worth ₹55 lakhs</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 overflow-hidden">
              <div className="p-10 space-y-6">
                <div className="space-y-4">
                  <p className="text-base md:text-lg leading-relaxed text-slate-600">
                    Thodupuzha Taluk Aided School Teachers' Cooperative Society Limited No. I-145. 
                    Registered as Employees Credit Cooperative Society under Kerala Co-op. Societies Act 1969, 
                    on 2nd November 1981. The area of business of the society is in Thodupuzha taluk. 
                    Teachers of aided schools falling under this area can become "A" class member of this society.
                  </p>
                  <p className="text-base md:text-lg leading-relaxed text-slate-600">
                    The head office of the society is situated at Thodupuzha Kothaikunnu Bypass. 
                    It is a 'Class I Special Grade' Co-operative Society with an audit classification of "A". 
                    We accept deposits at attractive rates of interest, provide different types of loans against 
                    salary certificates & collateral, and conduct about 30 monthly chits of worth Rs.55 lakhs.
                  </p>
                  <p className="text-base md:text-lg leading-relaxed text-slate-600">
                    We implemented all available modern facilities to help our customers. (SMS alert on all transactions, 
                    mobile banking, RTGS, NEFT, website, online chit auctions, CCTV surveillance, Cloud back ups etc.) 
                    It helps our customers transact more effectively. Teachers' Society has been fully computerized. 
                    Our society has safe deposit locker facility. This society has been running for profit for the past 30 years.
                  </p>
                </div>
              </div>
            </div>
       ...
       <section id="staff" className="py-16 md:py-24 lg:py-32 bg-gradient-to-br from-slate-50 via-white to-blue-50/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight tracking-tight bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-6">Our Team</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full mx-auto mb-8"></div>
            <p className="text-lg md:text-xl leading-relaxed text-slate-600 max-w-3xl mx-auto">
              Meet our dedicated team of professionals who work tirelessly to serve 
              the education community with excellence and care.
            </p>
          </div>
          <div className="mt-8">
            <StaffGrid />
      ...
      {/* Download Forms */}
      <section id="download" className="py-16 md:py-24 lg:py-32 bg-gradient-to-b from-white to-slate-50/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight tracking-tight bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-6">Download Forms</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full mx-auto mb-8"></div>
            <p className="text-lg md:text-xl leading-relaxed text-slate-600 max-w-3xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {[
              ...
              { title: 'A Class Membership Form', href: '/Forms/A Class Membership Form.pdf' },
              { title: 'Cash Credit Application', href: '/Forms/Cash Credit Application.pdf' },
              { title: 'RTGS-NEFT Form', href: '/Forms/RTGS-NEFT Form.pdf' },
              { title: 'Satharana Vaypakkulla Apeksha', href: '/Forms/Satharana Vaypakkulla Apeksha-1.pdf' },
              { title: 'Satharana Vaypakkulla(above 10 lac)', href: '/Forms/Satharana Vaypakkulla Apeksha-2.pdf' },
      ...
      <section id="contact" className="py-16 md:py-24 lg:py-32 bg-gradient-to-br from-blue-50/50 via-white to-purple-50/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight tracking-tight bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-6">Contact Us</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full mx-auto mb-8"></div>
            <p className="text-lg md:text-xl leading-relaxed text-slate-600 max-w-3xl mx-auto">
            ...
            <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 overflow-hidden transition-all duration-700 hover:shadow-3xl hover:-translate-y-2 group">
              <div className="p-8 space-y-6">
                ...
                <div className="space-y-3 text-slate-600">
                  <p className="text-base md:text-lg leading-relaxed">Thodupuzha taluk aided School<br/>Teachers co-operative society,</p>
                  <p className="text-base md:text-lg leading-relaxed">Kothaikunne Bypass,</p>
                  <p className="text-base md:text-lg leading-relaxed">Opposite kair baby shop.</p>
                  <p className="text-base md:text-lg leading-relaxed font-semibold">Pin Code: 685584</p>
                  <p className="text-base md:text-lg leading-relaxed font-semibold">City: Thodupuzha</p>
                </div>
              </div>
            </div>
              ...
              <div className="p-8 space-y-6">
                ...
                <div className="space-y-4 text-slate-600">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-base md:text-lg leading-relaxed">Phone: 8547852051</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full"></div>
                    <span className="text-base md:text-lg leading-relaxed">Tel: 04862 222051</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full"></div>
                    <a 
              ...
              <div className="p-8 space-y-6">
                ...
                <div className="space-y-3 text-slate-600">
                  <div className="flex justify-between items-center py-2 border-b border-slate-100">
                    <span className="text-base md:text-lg leading-relaxed font-medium">Monday - Friday</span>
                    <span className="text-base md:text-lg leading-relaxed">11:00 AM - 6:00 PM</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b border-slate-100">
                    <span className="text-base md:text-lg leading-relaxed font-medium">Saturday</span>
                    <span className="text-base md:text-lg leading-relaxed">10:00 AM - 2:00 PM</span>
                  </div>
                  <div className="flex justify-between items-center py-2">
                    <span className="text-base md:text-lg leading-relaxed font-medium">Sunday</span>
                    <span className="text-base md:text-lg leading-relaxed text-slate-400">Closed</span>
                  </div>
                </div>
              </div>
            </div>
