...
export const metadata: Metadata = {
  ...
  description:
    "Official website of the Aided School Teachers' Co-operative Society Thodupuzha",
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="scroll-smooth">
      <body
        className={`${inter.variable} ${playfair.variable} font-sans antialiased bg-gradient-to-br from-slate-50 via-white to-blue-50/30 min-h-screen`}
      >
        {/* Header */}
        <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-2xl border-b border-white/20 shadow-2xl">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="h-24 flex items-center justify-between">
              <Link
                href="/"
                className="group flex items-center space-x-6 transition-all duration-500 hover:scale-105"
              >
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              <div className="space-y-6">
                ...
                <p className="text-slate-300 leading-relaxed text-lg">
                  Empowering educators through cooperative services and
                  financial support for over three decades.
                </p>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  <Link
                    href="#about"
                    className="block text-slate-300 hover:text-white transition-all duration-300 hover:translate-x-2 group"
                  >
            ...
            <div className="border-t border-slate-700/50 mt-16 pt-8 flex flex-col md:flex-row justify-between items-center">
              <p className="text-slate-400 text-sm">
                © {new Date().getFullYear()} Aided School Teachers' Co-operative
                Society Thodupuzha. All rights reserved.
              </p>
